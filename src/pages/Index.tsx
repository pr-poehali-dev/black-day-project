            ...
            <div className="max-w-4xl">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  { 
                    name: 'Западно-Славянская республика', 
                    desc: 'Славянское государство, аналог России в мире BLACK DAY.',
                    icon: 'Flag',
                    color: 'bg-blue-600/10'
                  },
                  { 
                    name: 'Остранская империя', 
                    desc: 'Империя во главе с императрицей Анной Хорин. Местный аналог Российской империи.',
                    icon: 'Crown',
                    color: 'bg-amber-500/10'
                  },
                  { 
                    name: 'Социалистическая Федеративная Республика Астерия', 
                    desc: 'Федерация до распада. Аналог Югославии до 1991 года.',
                    icon: 'Users',
                    color: 'bg-red-600/10'
                  },
                  { 
                    name: 'Лиранская Демократическая Республика', 
                    desc: 'Демократическое государство, аналог США в этом мире.',
                    icon: 'Landmark',
                    color: 'bg-blue-700/10'
                  },
                  { 
                    name: 'Флассондрийская империя', 
                    desc: 'Империя, расположенная в горной местности. Аналог Кавказа.',
                    icon: 'Mountain',
                    color: 'bg-green-600/10'
                  },
                  { 
                    name: 'Аруценнская федерация', 
                    desc: 'Федерация южно-азиатских стран, близкая к российской модели, но не она.',
                    icon: 'Globe',
                    color: 'bg-orange-500/10'
                  },
                  { 
                    name: 'Иллирия', 
                    desc: 'Государство, жаждущее мести за неизвестные обиды прошлого.',
                    icon: 'Flame',
                    color: 'bg-purple-600/10'
                  },
                  { 
                    name: 'Заргская империя', 
                    desc: 'Империя вечной гражданской войны, раздираемая внутренними конфликтами.',
                    icon: 'Swords',
                    color: 'bg-red-700/10'
                  },
                  { 
                    name: 'Республика Саммардия', 
                    desc: 'Балканское государство, аналог Сербии.',
                    icon: 'Shield',
                    color: 'bg-blue-500/10'
                  },
                  { 
                    name: 'Республика Кинария', 
                    desc: 'Славянское государство, аналог Беларуси.',
                    icon: 'TreePine',
                    color: 'bg-green-500/10'
                  },
                  { 
                    name: 'Конфедерация', 
                    desc: 'Милитаристское государство, сочетающее китайский размах и германский патриотизм 1933 года.',
                    icon: 'Zap',
                    color: 'bg-gray-700/10'
                  },
                  { 
                    name: 'Республика Салария', 
                    desc: 'Государство-осколок Бургурий, аналог Республики Сербской.',
                    icon: 'Building',
                    color: 'bg-cyan-500/10'
                  },
                  { 
                    name: 'Северная Бургурия', 
                    desc: 'Северная часть разделённой Бургурий, аналог Боснии.',
                    icon: 'Home',
                    color: 'bg-teal-500/10'
                  },
                  { 
                    name: 'Республика Винария', 
                    desc: 'Прокси-государство, управляемое внешними силами.',
                    icon: 'Link',
                    color: 'bg-slate-500/10'
                  },
                  { 
                    name: 'Солгарский каганат', 
                    desc: 'Крайне бедное островное государство на периферии мира.',
                    icon: 'Anchor',
